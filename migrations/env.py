...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "packages", "config"))

from eventmesh_config.settings import get_settings  # noqa: E402
from eventmesh_database.models import Base  # noqa: E402
